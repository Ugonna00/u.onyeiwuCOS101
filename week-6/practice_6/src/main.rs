fn main() {
    ...
    println!("\nThe {} is informed by the aspiration to trim electrical/electronic engineering professionals in the area of design, building and maintenance of electrical control systems",n4);
